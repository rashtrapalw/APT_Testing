...
export function HighlightSection() {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-[#F8FAFB] dark:bg-[#0A0F1C]">

          
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5 mt-12">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-['Poppins'] font-bold text-4xl md:text-5xl text-[#0A0F1C] dark:text-white mb-6">
            Reliable • Efficient • <span className="text-[#00C853]">Scalable</span>
          </h2>
          <p className="font-['Inter'] text-xl text-[#0A0F1C]/70 dark:text-white/70 max-w-3xl mx-auto">
          ...
          {highlights.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-6 rounded-2xl bg-white dark:bg-[#1A1F2E] border border-[#00C853]/10 dark:border-[#00C853]/20 hover:border-[#00C853]/30 transition-all duration-300 shadow-sm hover:shadow-lg"
              >
                ...
                <div className="relative space-y-4">
                  ...
                  {/* Content */}
                  <div>
                    <h3 className="font-['Poppins'] font-semibold text-[#0A0F1C] dark:text-white mb-2 leading-tight">
                      {item.title}
                    </h3>
                    <p className="font-['Inter'] text-sm text-[#0A0F1C]/60 dark:text-white/60">
                      {item.description}
                    </p>
                  </div>
                </div>
