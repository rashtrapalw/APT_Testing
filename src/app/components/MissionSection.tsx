...
export function MissionSection() {
  ...
  return (
    <section id="mission" className="relative py-24 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#E0F7FA] to-[#F8FAFB] dark:from-[#1A1F2E] dark:to-[#0A0F1C]">
          ...
          {missions.map((mission, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-8 rounded-3xl bg-white/80 dark:bg-[#1A1F2E] backdrop-blur-sm border border-[#0A0F1C]/10 dark:border-[#0A0F1C]/50 hover:border-[#00C853]/50 transition-all duration-500 shadow-lg"
              >
                {/* Background Glow */}
