        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="font-['Poppins'] font-bold text-5xl md:text-6xl lg:text-7xl leading-tight"
            >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-full bg-gradient-to-r from-[#00C853] to-[#00E5FF] text-white font-['Inter'] font-semibold text-lg flex items-center gap-2 shadow-lg shadow-[#00C853]/30"
              >
                Explore Products
